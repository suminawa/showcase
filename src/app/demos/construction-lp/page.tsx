      ...
      <main id="top" className={s.main}>
        <section className={s.hero}>
          ...
          <div className={s.container}>
            ...
            <p className={s.lead}>
              蛇口のにじみ、動かないコンセント、効かないエアコン。そのままにしておくと、修理にかかる費用は増えていきます。まずは点検とお見積もりだけでもご依頼ください。直すかどうかは、金額をご覧になってからお決めいただけます。お見積もりは無料です。
            </p>
        ...
        <section id="area" className={s.section}>
          <div className={s.container}>
            ...
            <AreaTags />
            <p className={s.menuFoot}>
              対応エリアの外でも、出張費をいただければうかがえます。まずはお電話でご相談ください。
            </p>
          </div>
        </section>
