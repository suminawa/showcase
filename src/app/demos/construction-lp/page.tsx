...
const STEPS = [
  ...
  {
    title: "訪問して点検します",
    body: "お約束の時間にうかがい、原因を調べます。必要に応じて床下や壁の中まで確認いたします。",
  },
  {
    title: "お見積もりをお出しします",
      ...
      <main id="top" className={s.main}>
        <section className={s.hero}>
          ...
          <div className={s.container}>
            ...
            <h1 className={s.h1}>
              水まわりと電気のお困りごと、当日うかがいます
            </h1>
            <p className={s.lead}>
              蛇口のにじみ、動かないコンセント、効かないエアコン。そのままにしておくと、修理にかかる費用は増えていきます。まずは点検とお見積もりだけでもご依頼ください。直すかどうかは、お見積もり後に決めていただけます。お見積もりは無料です。
            </p>
            ...
            <p className={s.fine}>
              お見積もり後にお断りいただいても、費用はかかりません。夜間と休日も受け付けております。
            </p>
          </div>
        </section>
        ...
        <section id="menu" className={s.section}>
          <div className={s.container}>
            <h2 className={s.h2}>こんな作業を承っています</h2>
            <ul className={s.menu}>
              {SERVICES.map((item) => (
            ...
            <p className={s.menuFoot}>
              金額はすべて税込みです。現場を拝見してから正式なお見積もりを提示いたします。
            </p>
          </div>
        </section>
        ...
        <section id="price" className={`${s.section} ${s.soft}`}>
          <div className={s.container}>
            ...
            <p className={s.sectionLead}>
              作業の代金は、この目安に部品代と作業時間分を加えた金額です。時間帯を切り替えてご確認ください。
            </p>
            <PriceTable />
          </div>
        </section>
        ...
        <section id="area" className={s.section}>
          <div className={s.container}>
            ...
            <AreaTags />
            <p className={s.menuFoot}>
              対応エリアの外でも、距離に応じた追加出張費をいただければうかがえます。まずはお電話でご相談ください。
            </p>
          </div>
        </section>
          ...
          <div className={`${s.container} ${s.contact}`}>
            <div>
              ...
              <p className={s.contactLead}>
                症状と場所をご記入いただければ、折り返しご連絡いたします。夜間にいただいたご相談は、翌朝 8 時から順にお返事いたします。
              </p>
            </div>
