...
const HISTORY = [
  { year: "2002 年", body: "計測機器の保守を請け負う会社として始める。" },
  { year: "2007 年", body: "自社の観測ブイを海に置き、水温と塩分の記録を始める。" },
  {
    year: "2012 年",
    body: "解析の部署をつくり、報告書の作成まで一社で行うようになる。",
  },
  {
    year: "2018 年",
    body: "観測データを自動で集める仕組みを整え、現場に出る回数を減らす。",
  },
  {
    year: "2024 年",
    body: "長期の記録を公開する仕組みをつくり、大学との共同研究を始める。",
  },
];
...
const POLICIES = [
  {
    title: "測った数字を、そのまま出す。",
    body: "都合のよい数字だけを選びません。測れなかったことも報告書に書きます。数字は数字のまま出します。",
  },
  {
    title: "現場を見てから決める。",
    body: "海の条件は場所ごとに違います。機器の置き方は、現地を見てから決めます。",
  },
  {
    title: "記録を絶やさない。",
    body: "一度はじめた観測を途切れさせないことを、いちばん先に置いています。",
  },
];
