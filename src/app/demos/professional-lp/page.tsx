...
const SERVICES = [
  {
    title: "税務調査の立ち会い",
    body: "事前の打ち合わせから当日の立ち会い、調査後の対応まで承ります。聞かれそうなことと答え方は、事前に一緒に整理します。",
    icon: (
  ...
  {
    title: "記帳と決算",
    body: "月ごとの記帳から決算・申告までお引き受けします。領収書や請求書のやり取りはオンラインで完結します。",
    icon: (
      <svg viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  {
    title: "経理研修",
    body: "経理のご担当者に向けて、半日の研修を行います。仕訳の考え方と、月次を締めるまでの手順をお伝えします。",
    icon: (
      <svg viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="2">
...
const STEPS = [
  ...
  {
    title: "30 分の無料相談",
    body: "オンラインで状況をうかがい、何が必要かをお伝えします。",
  },
  { title: "お見積もりとご契約", body: "料金と範囲を書面でお示しします。" },
...
const FAQ = [
  {
    q: "初回の相談は本当に無料ですか。",
    a: "30 分までは無料です。それを超える場合は、先に料金をお伝えします。",
  },
  {
    q: "顧問契約をしていなくても、税務調査の立ち会いを頼めますか。",
    a: "顧問契約がなくてもお受けします。スポットの料金でご依頼いただけます。過去の申告書を拝見してから、お見積もりします。",
  },
  {
    q: "遠方でも依頼できますか。",
    a: "はい、承ります。面談も書類のやり取りも、オンラインで完結します。",
  },
  {
    q: "記帳は自分でやりたいのですが、見てもらえますか。",
    a: "拝見します。会計ソフトの画面を共有していただき、仕訳の付け方を確認します。",
  },
  {
    q: "研修は何人まで受けられますか。",
    a: "1 回あたり 10 人までです。人数が多い場合は、2 回に分けて行います。",
  },
];
        ...
        <section id="pricing" className={s.section}>
          <div className={s.container}>
            ...
            <p className={s.pricingNote}>
              価格は税込みです。記帳の代行や過去の分の申告が必要な場合は、範囲をうかがったうえで別途お見積もりします。
            </p>
          </div>
        </section>
          ...
          <div className={`${s.container} ${s.contact}`}>
            <div>
              ...
              <p className={s.contactLead}>
                お名前、メールアドレス、電話番号、ご相談の内容、ご希望の日時をご記入ください。当日か翌営業日にご返信します。
              </p>
            </div>
            <DemoForm
