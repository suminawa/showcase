  ...
  return (
    <main className={`${s.paper} ${fontVars}`}>
      ...
      <div className={s.work}>
        ...
        <p className={s.lede}>
          この見本は「スプレッドシート業務アプリ キット」（定価 ¥12,800
          の買い切り。10 月 2 日までは 1.1 の発売記念 ¥9,800）の実物です。定義シートからの画面生成・CSV・AI
          の絞り込みと要約・見本 3 種に加え、1.1 で登録・更新の LINE・Slack 通知と、記録からの LINE 送信（この見本でも「LINE で送る」を試せます）
