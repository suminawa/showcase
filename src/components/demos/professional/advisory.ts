...
export const ADVISORY_PLANS: readonly AdvisoryPlan[] = [
  {
    ...
    note: "記帳の代行が必要な場合は、月額 5,000 円を別途申し受けます。",
  },
  {
    id: "corp",
    name: "法人",
    ...
    note: "消費税の申告が必要な場合も、料金は変わりません。",
  },
  {
    id: "spot",
    name: "スポット",
    audience: "顧問契約はせず、必要なときだけご利用いただく方へ",
    lines: [
      { label: "税務調査の立ち会い（1 日）", price: 80000, unit: "spot" },
      { label: "決算・申告のみ", price: 120000, unit: "spot" },
      { label: "経理研修（半日）", price: 60000, unit: "spot" },
    ],
    // 上の 3 行（立ち会い・決算のみ・研修）のどれを頼まれても付くもの。
    // 立ち会いの話だけを書かない
    includes: [
      "事前の打ち合わせ（1 時間）",
      "お約束の日までの作業",
